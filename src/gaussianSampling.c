/*
 * @Author: B1ank
 * @Date: 2022-12-22 22:45:53
 * @LastEditTime: 2022-12-23 23:10:17
 * @LastEditors: your name
 * @Description: Discrete Gaussian sampling operation to figure out the 
 * coefficients of sampled polynomial, finally we got the polynomial with coefficients
 * located in [4,6)
 * @FilePath: /FTCR-LMPPDA/src/gaussianSampling.c
 */
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
...
void samplingPolynomials(poly *r){
	...
	// Suppose the degree of polynomial is the multiples of 64
	// So repeatTime = 1/2/....
	uint16_t N = r->N;
	uint16_t repeatTime = N / 64;
...
&~bit[58]) | (~bit[61]&~bit[60]&bit[59]&bit[58]) | (bit[62]&bit[61]&~bit[60]&bit[58]) | (bit[62]&~bit[60]&~bit[59]&~bit[58]) | (~bit[62]&bit[61]&bit[60]))) | (disable_update & out[0]);
		...
		// TODO: Extend 64-bit Gaussian sampling results to 128 bits.
